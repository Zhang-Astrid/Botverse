<template>
  <el-card class="box-card">
    <div slot="header" class="clearfix">
      ...
      <div class="button">
        ...
        <el-button style="float: right;margin-right: 10px;" type="primary" @click="openRecharge" v-if="is_current">
          充值
        </el-button>
      </div>
    </div>
  ...
  <!-- 编辑模式下的弹出窗口 -->
  <el-dialog v-model="dialogVisible" title="充值" class="inside-class">
